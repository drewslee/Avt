...
*/
        ...
        SSF.get_table = function get_table()/*:SSFTable*/ {
            return table_fmt;
        };
...
// Grab FAT Sector Locations
            ...
            var files/*:CFBFiles*/ = {}, Paths/*:Array<string>*/ = [], FileIndex/*:CFBFileIndex*/ = [],
...
// $FlowIgnore
        ...
        function read(blob/*:RawBytes|string*/, options/*:CFBReadOpts*/) {
            switch (options && options.type || "base64") {
                case "file": /*:: if(typeof blob !== 'string') throw "Must pass a filename when type='file'"; */
                    return read_file(blob, options);
                case "base64": /*:: if(typeof blob !== 'string') throw "Must pass a base64-encoded binary string when type='file'"; */
                    return parse(s2a(Base64.decode(blob)), options);
                case "binary": /*:: if(typeof blob !== 'string') throw "Must pass a binary string when type='file'"; */
...
// TODO: CP remap (need to read file version to determine OS)
    ...
    if (has_buf) {
        ...
        utf8write = function (data) {
            return new Buffer(data, 'utf8').toString("binary");
        };
    }
...
// matches <foo>...</foo> extracts content
    ...
    var __toBuffer = function (bufs/*:Array<Array<RawBytes> >*/)/*:RawBytes*/ {
        var x = [], w = 10240;
        for (var i = 0; i < bufs[0].length; ++i) if (bufs[0][i]) for (var j = 0, L = bufs[0][i].length; j < L; j += w) x.push.apply(x, bufs[0][i].slice(j, j + w));
        return x;
    };
    var ___toBuffer = __toBuffer;
    var __utf16le = function (b/*:RawBytes|CFBlob*/, s/*:number*/, e/*:number*/)/*:string*/ {
        var ss/*:Array<string>*/ = [];
        for (var i = s; i < e; i += 2) ss.push(String.fromCharCode(__readUInt16LE(b, i)));
        return ss.join("").replace(chr0, '');
    };
    var ___utf16le = __utf16le;
    var __hexlify = function (b/*:RawBytes|CFBlob*/, s/*:number*/, l/*:number*/)/*:string*/ {
        var ss/*:Array<string>*/ = [];
        for (var i = s; i < s + l; ++i) ss.push(("0" + b[i].toString(16)).slice(-2));
        return ss.join("");
    };
    var ___hexlify = __hexlify;
    var __utf8 = function (b/*:RawBytes|CFBlob*/, s/*:number*/, e/*:number*/) {
        var ss = [];
        for (var i = s; i < e; i++) ss.push(String.fromCharCode(__readUInt8(b, i)));
        return ss.join("");
    };
    var ___utf8 = __utf8;
    var __lpstr = function (b/*:RawBytes|CFBlob*/, i/*:number*/) {
        var len = __readUInt32LE(b, i);
        return len > 0 ? __utf8(b, i + 4, i + 4 + len - 1) : "";
    };
    var ___lpstr = __lpstr;
    var __cpstr = function (b/*:RawBytes|CFBlob*/, i/*:number*/) {
        var len = __readUInt32LE(b, i);
        return len > 0 ? __utf8(b, i + 4, i + 4 + len - 1) : "";
    };
    var ___cpstr = __cpstr;
    var __lpwstr = function (b/*:RawBytes|CFBlob*/, i/*:number*/) {
        var len = 2 * __readUInt32LE(b, i);
        return len > 0 ? __utf8(b, i + 4, i + 4 + len - 1) : "";
    };
    var ___lpwstr = __lpwstr;
    var __lpp4, ___lpp4;
    __lpp4 = ___lpp4 = function lpp4_(b/*:RawBytes|CFBlob*/, i/*:number*/) {
        var len = __readUInt32LE(b, i);
        return len > 0 ? __utf16le(b, i + 4, i + 4 + len) : "";
    };
    var __8lpp4 = function (b/*:RawBytes|CFBlob*/, i/*:number*/) {
        var len = __readUInt32LE(b, i);
        return len > 0 ? __utf8(b, i + 4, i + 4 + len) : "";
    };
    var ___8lpp4 = __8lpp4;
    var __double, ___double;
    __double = ___double = function (b/*:RawBytes|CFBlob*/, idx/*:number*/) {
    ...
    if (has_buf/*:: && typeof Buffer !== 'undefined'*/) {
        ...
        __hexlify = function (b/*:RawBytes|CFBlob*/, s/*:number*/, l/*:number*/)/*:string*/ {
        ...
        __utf8 = function utf8_b(b/*:RawBytes|CFBlob*/, s/*:number*/, e/*:number*/) {
...
//	if(s + length != blob.l) throw new Error("TxO " + (s + length) + ", at " + blob.l);
    ...
    function parse_FilePass(blob, length/*:number*/, opts) {
        var o = ({Type: opts.biff >= 8 ? blob.read_shift(2) : 0}/*:any*/);
        /* wEncryptionType */
	...
	*/
    ...
    function parse_SerAr(blob, biff/*:number*/) {
        ...
        switch (val[0]) {
            ...
            case 0x02: /* SerStr -- XLUnicodeString (<256 chars) */
                ...
                break;
            default:
                throw "Bad SerAr: " + val[0]; /* Unreachable */
        }
        return val;
    }
        ...
        for (var ff = 0, fflen = formula[0].length; ff < fflen; ++ff) {
            ...
            switch (f[0]) {
                ...
                case 'PtgRef': /* [MS-XLS] 2.5.198.84 */
                    /*::type = f[1][0]; */
                    c = shift_cell_xls((f[1][1]/*:any*/), _range, opts);
                    stack.push(encode_cell_xls(c, biff));
                    break;
                case 'PtgRefN': /* [MS-XLS] 2.5.198.88 */
                    /*::type = f[1][0]; */
                    c = cell ? shift_cell_xls((f[1][1]/*:any*/), cell, opts) : (f[1][1]/*:any*/);
                    stack.push(encode_cell_xls(c, biff));
                    break;
    ...
    var parse_ws_xml_data = (function () {
        ...
        return function parse_ws_xml_data(sdata/*:string*/, s, opts, guess/*:Range*/, themes, styles) {
            var ri = 0, x = "", cells/*:Array<string>*/ = [], cref/*:?Array<string>*/ = [], idx = 0, i = 0, cc = 0,
                d = "", p/*:any*/;
    ...
    function write_ws_xml_data(ws/*:Worksheet*/, opts, idx/*:number*/, wb/*:Workbook*//*::, rels*/)/*:string*/ {
        var o/*:Array<string>*/ = [], r/*:Array<string>*/ = [], range = safe_decode_range(ws['!ref']), cell = "", ref,
            rr = "", cols/*:Array<string>*/ = [], R = 0, C = 0, rows = ws['!rows'];
        var dense = Array.isArray(ws);
...
//var xlmlregex = /<(\/?)([a-z0-9]*:|)(\w+)[^>]*>/mg;
    function parse_xlml_xml(d, _opts)/*:Workbook*/ {
        ...
        var state = [], tmp;
        if (DENSE != null && opts.dense == null) opts.dense = DENSE;
        var sheets = {}, sheetnames/*:Array<string>*/ = [], cursheet/*:Worksheet*/ = (opts.dense ? [] : {}),
            sheetname = "";
...
// $FlowIgnore
    ...
    (function (utils) {
        ...
        function get_default(x/*:any*/, y/*:any*/, z/*:any*/)/*:any*/ {
        ...
        utils.cell_set_internal_link = function (cell/*:Cell*/, range/*:string*/, tooltip/*:?string*/) {
