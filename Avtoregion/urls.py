...
urlpatterns = [
    ...
    url(r'^Race/copy/ajax', views.AjaxCopyRace.as_view(), name='RaceCopyAjax'),
    ...
    url(r'^Car/(?P<pk>\d+)/update/$', views.CarUpdate.as_view(template_name='Avtoregion/update_form4.html'),
        name='CarUpdate'),
    ...
    url(r'^Unit/(?P<pk>\d+)/update/$', views.UnitUpdate.as_view(template_name='Avtoregion/update_form4.html'),
        name='UnitUpdate'),
    ...
    url(r'^Product/(?P<pk>\d+)/update/$', views.ProductUpdate.as_view(template_name='Avtoregion/update_form4.html'),
        name='ProductUpdate'),
    ...
    url(r'^Driver/(?P<pk>\d+)/update/$', views.DriverUpdate.as_view(template_name='Avtoregion/update_form4.html'),
        name='DriverUpdate'),
    ...
    url(r'^Abonent/(?P<pk>\d+)/update/$', views.AbonentUpdate.as_view(template_name='Avtoregion/update_form4.html'),
        name='AbonentUpdate'),
    ...
    url(r'^Supplier/(?P<pk>\d+)/update/$', views.SupplierUpdate.as_view(template_name='Avtoregion/update_form4.html'),
        name='SupplierUpdate'),
    ...
    url(r'^Supplier/(?P<supplier>\d+)/load_place/update/(?P<pk>\d+)/$',
        views.LoadUpdate.as_view(template_name='Avtoregion/update_form4.html'), name='LoadUpdate'),
    ...
    url(r'^Customer/(?P<pk>\d+)/update/$', views.CustomerUpdate.as_view(template_name='Avtoregion/update_form4.html'),
        name='CustomerUpdate'),
    ...
    url(r'^Customer/(?P<customer>\d+)/unload_place/update/(?P<pk>\d+)/$',
        views.ShipmentUpdate.as_view(template_name='Avtoregion/update_form4.html'), name='ShipmentUpdate'),
    ...
    url(r'^Trailer/(?P<pk>\d+)/update/$', views.TrailerUpdate.as_view(template_name='Avtoregion/update_form4.html'),
        name='TrailerUpdate'),
    ...
    url(r'^Mediator/(?P<pk>\d+)/update/$', views.MediatorUpdate.as_view(template_name='Avtoregion/update_form4.html'),
        name='MediatorUpdate'),
