...
urlpatterns = [
    ...
    url(r'^Product/$', views.ProductViewList.as_view(), name='Product'),
    ...
    url(r'^Driver/$', views.DriverViewList.as_view(), name='Driver'),
    ...
    url(r'^Supplier/$', views.SupplierViewList.as_view(), name='Supplier'),
    ...
    url(r'^Trailer/$', views.TrailerViewList.as_view(), name='Trailer'),
    ...
    url(r'^Mediator/$', views.MediatorViewList.as_view(), name='Mediator'),
    ...
    url(r'^Shipment/$', views.ShipmentViewList.as_view(), name='Shipment'),
