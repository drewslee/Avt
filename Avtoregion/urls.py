...
urlpatterns = [
    ...
    url(r'^Customer/update(?P<pk>\d+)/$', views.CustomerUpdate.as_view(template_name='Avtoregion/update_form.html'), name='CustomerUpdate'),
    ...
    url(r'^Trailer/update(?P<pk>\d+)/$', views.TrailerUpdate.as_view(template_name='Avtoregion/update_form.html'), name='TrailerUpdate'),
    ...
    url(r'^Mediator/update(?P<pk>\d+)/$', views.MediatorUpdate.as_view(template_name='Avtoregion/update_form.html'), name='MediatorUpdate'),
